        ...
        <div id="home_projekte">
            ...
            <ul >
               ...
               <li id="home_projekte_li"              
                > 
                <Home_Projekt_Banner title={Projekt.name} Kategorie={Projekt.KategorieLink} Finanzierungsvolumen={Projekt.Finanzierungsvolumen} ErwarteteRendite={Projekt.ErwRendite} Typ={Projekt.Typ} Logo={Projekt.LogoLink} titleImg={Projekt.TitleLink}        />
